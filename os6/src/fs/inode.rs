...
pub fn create_new_dir_entry(o_name: &str,n_name: &str)->isize{
    // let inode_id = ROOT_INODE.find_inode_id_by_name(o_name).unwrap();
    // let o_inode = ROOT_INODE.find(o_name).unwrap();
    ROOT_INODE.create_hard_link(o_name, n_name)
